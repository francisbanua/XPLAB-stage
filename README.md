...
### agenda-01.pwk
###### 12/06/23 - 13/06/23
#### Lets you add, edit, delete information (surname, name, number) about a person in a table
...
### rete-01.pwk
###### 13/06/23
#### Shows a cam and lets you send and receive messages, specifying the destination ip
...
### grid-02.pwk
###### 15/06/23 - 19/06/23
#### Lets you add, edit, delete, choose a color and draw a point in a panel 
